/* Generated By:JavaCC: Do not edit this line. ADSL.java */
...
public class ADSL implements ADSLConstants {

    public static void main(String args[]) {
        ListaValor entrada = new ListaValor();
            ADSL parser;
            if (args.length == 0) {
                System.out.println("ADSL Parser Version 1.0:  Reading from standard input . . .");
                parser = new ADSL(System.in);
            } else  {
                System.out.println("ADSL Parser Version 1.0:  Reading from file " + args[0] + " . . .");
                try {
                        parser = new ADSL(new java.io.FileInputStream(args[0]));
            ...
            System.out.println("ADSL Parser Version 1.0:  Imperativa2 program parsed successfully.");
            ...
            System.out.println("ADSL Parser Version 1.0:  Encountered errors during parse.");
            e.printStackTrace();
        }
        }
  ...
  static final public IMP_IO PIO() throws ParseException {
        IMP_IO retorno;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case READ:
      retorno = PRead();
...
/*  ADICIONADO OU MODIFICADO DA Imperativa1 PARA A Imperativa2  */
  ...
  static public ADSLTokenManager token_source;
